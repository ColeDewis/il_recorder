...
Script to inspect an hdf5 file recorded by il_recorder, and ensure you have the correct data and shapes.

Usage: ros2 run il_recorder inspect_hdf5 <path_to_hdf5_file>
